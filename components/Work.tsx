...
function WorkVisual({ slug, tone }: { slug: string; tone: "flame" | "dark" }) {
  ...
  const pulseColor = tone === "flame" ? "#7a2408" : "#ff6a3d";
  ...
  if (slug === "tdis-logistics") {
    return (
      <svg viewBox="0 0 340 260" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <line x1="84" y1="64" x2="84" y2="104" stroke={activeStroke} strokeDasharray="3 5" style={{ animation: "dash 2.4s linear infinite" }} />
        ...
        <FlowPulse path="M0,0 L0,114" cx={84} cy={64} fill={pulseColor} duration={2.6} />
      </svg>
    );
  }
  if (slug === "globetech") {
    return (
      <svg viewBox="0 0 340 260" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <line x1="195" y1="54" x2="195" y2="94" stroke={activeStroke} strokeDasharray="3 5" style={{ animation: "dash 2.4s linear infinite" }} />
        ...
        <FlowPulse path="M0,0 L0,40" cx={195} cy={54} fill={pulseColor} duration={2.2} />
      </svg>
    );
  }
  return (
    <svg viewBox="0 0 340 260" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <line x1="100" y1="129" x2="140" y2="129" stroke={activeStroke} strokeDasharray="4 5" style={{ animation: "dash 2.2s linear infinite" }} />
      ...
      <FlowPulse path="M0,0 L40,0" cx={100} cy={129} fill={pulseColor} duration={2} />
    </svg>
  );
}
      ...
      <div className="wrap">
        <div className="section-head">
          <div className="section-head__meta">
            ...
            <h2 className="display-2"><WordReveal text="Three systems, three problems." /></h2>
          </div>
