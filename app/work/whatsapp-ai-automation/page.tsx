...
export default function WhatsappAiAutomationPage() {
  return (
    <CaseStudyShell
      ...
      lede="AI-assisted conversation handling and backend logic for WhatsApp-based bookings and business workflows, the direction Bidemi's work is heading through Fudur Automation."
      meta={[
    ...
    >
      ...
      <CaseStudyBlock num="03" title="The System">
        ...
        <p>
          This project is the foundation for <strong>Fudur Automation</strong>, a product Bidemi
